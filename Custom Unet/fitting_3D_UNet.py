...
if __name__ == "__main__":
    ...
    learning_rate = 1e-3
    weight_decay = 1e-5
    loss_function = DiceLoss(include_background=True, to_onehot_y=True, sigmoid=True, squared_pred=True)
    ...
    add_losses_to_excel("3D UNet Training Log.xlsx", train_loss, test_loss)
